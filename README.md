...
Components are capable of provisioning infrastructure across all providers & SaaS vendors.  Components can also include application logic and automation to manage their lifecycle.

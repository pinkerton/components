...
Serverless Components can deploy anything, however they are biased toward SaaS and cloud infrastructure with "serverless" qualities (auto-scaling, pay-per-use, zero-administration).  Deliver results with the lowest total cost & overhead.

...
**Easy -** Serverless Components package *cloud services*, *logic* & *automation* into simple building blocks you can use to build applications more easily than ever.
